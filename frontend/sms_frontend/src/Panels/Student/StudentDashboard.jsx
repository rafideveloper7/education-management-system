/**
 * ============================================================================
 * FILE: src/Panels/Student/StudentDashboard.jsx
 * PURPOSE: Student Panel Entry Dashboard (Isolated UI)
 * ============================================================================
 */
  ...
  return (
    <div style={{ padding: '30px', textAlign: 'left', maxWidth: '1000px', margin: '0 auto' }}>
      <div style={{
        ...
        <div>
          <h1 style={{ margin: '0 0 6px 0', fontSize: '28px' }}>Student Dashboard 🎒</h1>
      ...
      <div style={{
        ...
        <div style={{ padding: '20px', borderRadius: '12px', background: 'var(--code-bg)', border: '1px solid var(--border)' }}>
          ...
          <p style={{ fontSize: '14px', color: 'var(--text)', margin: 0 }}>
            Student components live in <code>src/Panels/Student/</code>
          </p>
        </div>
      </div>
    </div>
