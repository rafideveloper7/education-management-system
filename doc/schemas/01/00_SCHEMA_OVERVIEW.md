# Master Schema Architecture & Domain Index

## Education Management System (EduOS) Data Architecture

This document serves as the master overview and index for the conceptual and logical schema design of the Education Management System. It explains the domain boundaries, data models, entity relationships, and architectural decisions guiding the system in plain, human-friendly terms.
...
└────────┬─────────┘ └────────┬─────────┘ └────────┬─────────┘
         ...
         └────────────────────┼────────────────────┘
                              ...
                              ▼
┌────────────────────────────────────────────────────────┐
│              🏫 CENTRAL OPERATIONAL ENGINES            │
│   • 📋 Attendance Register    • 💰 Fees & Billing       │
│   • 📝 Homework & Submissions • ✉️ Requests & Leaves    │
│   • 🏆 Exams & Report Cards   • 🪪 QR ID Cards          │
└────────────────────────────────────────────────────────┘
```

---

## 📑 2. Domain Schema Documents Index

All 14 domains have been structured into dedicated, easy-to-read documents:

| # | Domain Specification File | Scope & Focus Areas |
|---|---|---|
| **01** | [**01_USERS_AND_AUTHENTICATION.md**](./01_USERS_AND_AUTHENTICATION.md) | Universal logins, passwords, security sessions, and role permissions |
| **02** | [**02_STUDENTS_AND_PARENTS.md**](./02_STUDENTS_AND_PARENTS.md) | Student profiles, guardian links, multi-child parent handling, documents |
| **03** | [**03_TEACHERS_AND_STAFF.md**](./03_TEACHERS_AND_STAFF.md) | Faculty profiles, designations, qualifications, and teaching allocations |
...
## 🎯 3. Core Architectural Decisions at a Glance
